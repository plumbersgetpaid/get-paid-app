    ...
    const claudeRes = await fetch("https://api.anthropic.com/v1/messages", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "user",
            content: `A UK tradesperson is quickly booking a new job into their calendar via a rough spoken note, without having sent a formal quote first. Today is ${todayLabel}. Reply with ONLY a JSON object, no markdown fences, no explanation, in this exact shape: {"customerName": "name mentioned, or null", "jobType": "short description of the job, or null", "amount": a plain number if a price was mentioned, otherwise null, "startDate": "YYYY-MM-DD", "startTime": "HH:MM" (24-hour), "durationValue": a plain number, "durationUnit": "hours" or "days"}. If no date was mentioned, use tomorrow's date. If no time was mentioned, use "09:00". If no duration was mentioned, use 2 hours. Do not invent a customer name or price if none was said.\n\nTranscript: "${transcript}"`,
          },
        ],
      }),
    });
